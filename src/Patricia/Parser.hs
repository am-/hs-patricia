...
happyReduction_1 (HappyAbsSyn5  happy_var_3)
	...
	(HappyAbsSyn4  happy_var_1)
	 =  HappyAbsSyn4
		 (liftA2 parallelize happy_var_1 happy_var_3
	)
...
happyReduction_3 (HappyAbsSyn5  happy_var_3)
	...
	(HappyAbsSyn6  happy_var_1)
	 =  HappyAbsSyn5
		 (liftA2 TryThen happy_var_1 happy_var_3
	)
...
happyReduction_5 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (flip RunWithTimeout happy_var_3 . name2tool happy_var_1
	) `HappyStk` happyRest

happyReduce_6 = happySpecReduce_1  6 happyReduction_6
happyReduction_6 (HappyTerminal (TokenName happy_var_1))
	 =  HappyAbsSyn6
		 (Run . name2tool happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TokenTryThen -> cont 7;
	TokenParallel -> cont 8;
	TokenParOpen -> cont 9;
	TokenParClose -> cont 10;
...
action tks = happySomeParser where
